      ...
      * .cpy extension is optional
       ...
       Procedure Division.
           ...
           if GU-Show-Values
               display ' '
               display function trim(GU-Test-Description)
               display '--- AssertEquals-Numeric - Data Received ----'
               display '  Actual: 'GU-Actual-Value-Numeric  
               display 'Expected: 'GU-Expected-Value-Numeric
               display ' '
           end-if.               
           ...
           if GU-Show-Values
               display ' '
               display function trim(GU-Test-Description)
               display '--- AssertNotEquals-Numeric - Data Received ---'
           ...
           if GU-Show-Values
              display ' '
              display function trim(GU-Test-Description)
              display '-- AssertEquals-String - Data Received ----'
           ...
           if GU-Show-Values
               display ' '
               display function trim(GU-Test-Description)
               display '-- AssertNotEquals-String - Data Received ----'
               Perform 1100-Show-Values-String
                  thru 1100-Show-Values-String-Exit
           end-if.                
           ...
           goback.
      *****************************************************************
           Entry 'GU-AssertEquals-Table' using GUnit-Test-Fields.

           if GU-Show-Values
               display ' '
               display function trim(GU-Test-Description)
               display '--- AssertEquals-Table - Data Received ----'
               display '  Actual Table: 'GU-Actual-Table 
               display 'Expected Table: 'GU-Expected-Table
               display ' '
           end-if.               
          
           if(GU-Actual-Table equal GU-Expected-Table)
             set GU-Test-Passed to True
           else
             set GU-Test-Failed to True
           end-if.
