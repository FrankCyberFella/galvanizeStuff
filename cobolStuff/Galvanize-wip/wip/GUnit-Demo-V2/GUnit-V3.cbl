      ...
      * .cpy extension is optional
       ...
       Procedure Division.
           ...
           Entry 'Initialize-Default-Values' using GUnit-Test-Fields.
           ...
           Initialize Actual-Value-Numeric
           ...
           if(Actual-Value-Numeric equal Expected-Value-Numeric)
             ...
             set Test-Failed to True
             Display 'GUNit - Equals Test Failed'
             if Do-Not-Show-Values 
           ...
           if(Actual-Value-Numeric not equal Expected-Value-Numeric)
             ...
             set Test-Failed to True
             Display 'GUNit - Not Equals Test Failed'
             if Do-Not-Show-Values 
                Perform 1200-Show-Values-Numeric
             end-if 
           end-if.
