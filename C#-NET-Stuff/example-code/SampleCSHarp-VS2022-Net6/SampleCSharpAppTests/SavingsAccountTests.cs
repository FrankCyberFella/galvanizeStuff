...
public class SavingsAccountTests
{
    ...
    private SavingsAccount InstantiateDefaultTestSavingsAccount()
    {
        ...
        SavingsAccount aSavingsAccount = new SavingsAccount(defaultOwner, defaultStartingBalance, defaultInterestRate);

        if (aSavingsAccount == null)
        {
            throw new System.Exception("Unable to instantiate a Savings account");
        }
