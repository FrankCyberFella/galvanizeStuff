...
namespace TechElevator.Exercises.LogicalBranching
{
    ...
    public class ShippingTotal
    {
        ...
        public double CalculateShippingRate(int weightInPounds)
        {
            ...
            // return (weightInPounds > MaxWeightPounds) ? Over40PoundRate : UpTo40PoundRate;
        }
        ...
        {
            double costPerPound = CalculateShippingRate(weightInPounds);

            return weightInPounds * costPerPound;
        }
        ...
        {
            double total = CalculateShippingTotal(weightInPounds);
