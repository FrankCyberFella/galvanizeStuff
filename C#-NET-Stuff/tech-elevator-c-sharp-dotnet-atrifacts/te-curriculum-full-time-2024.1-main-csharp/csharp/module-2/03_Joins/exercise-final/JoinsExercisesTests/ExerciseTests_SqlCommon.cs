...
namespace ExercisesTests
{
    public partial class ExerciseTests
    {
        ...
        private void CheckAnswerForProblem(string problemNumber, string hint = "")
        {
            ...
            TestSuite(dtExpected, dtActual, hint);
        }


        private static void TestSuite(DataTable dtExpected, DataTable dtActual, string hint)
        {
            ...
            {
                Assert.AreEqual(dtExpected.Rows.Count, dtActual.Rows.Count, $"Expected row count doesn't match actual row count.{System.Environment.NewLine}{hint}");
            }
