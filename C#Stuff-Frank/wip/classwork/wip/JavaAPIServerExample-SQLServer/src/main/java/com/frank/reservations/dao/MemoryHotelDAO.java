...
public class MemoryHotelDAO implements HotelDAO {
    ...
    private void setHotels() {
        hotels.add(new Hotel(1,
                "Aloft Cleveland",
                "1111 W 10th St,  Cleveland ,Ohio,44115",
                4,
                48,274));
        hotels.add(new Hotel(2,
                "Hilton Cleveland Downtown",
                "100 Lakeside Ave, Cleveland, Ohio 44114",
                4,
                12,287));
        hotels.add(new Hotel(3,
                "Metropolitan at the 9",
                "2017 E 9th St, Cleveland, Ohio, 48226",
                5,
                22,319));
        ...
        hotels.add(new Hotel(6,
                ...
                "5345 Medpace Way, Cincinnati Ohio 43215",
                4,
                43,218));
        hotels.add(new Hotel(7,
                "Greektown Detroit",
                "1200 St Antoine St, Detroit Michigan 48226",
                4,
                75,185));
    }
}
